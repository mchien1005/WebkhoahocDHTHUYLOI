...
<body>
   ...
   <div class="login">
        ...
        <div id="popup-overlay"
            ...
            <!-- Popup chính -->
            <div class="popup active row p-4 rounded shadow-lg" style="background-color: #e7f5ff!important;; z-index: 1051;"
                onclick="event.stopPropagation()">
                <!-- HEADER -->
                <div class="modal-header border-bottom p-0" style="border-bottom: 2px solid #225293 !important;">
                    <h3 class="mb-0 d-flex align-items-center" style="color: #225293;">
                        <img src="{{ asset('img/Megaphone.png') }}" width="30" class="me-3"> Thông báo
                    </h3>
                </div>

                <!-- BODY -->
                <div class="modal-body text-start d-flex align-items-start justify-content-start mt-4">
                    <img src="{{ asset('images/Cancel.png') }}" width="50" class="me-3">
                    <span class="fw-bold" style="font-size: 30px; font-family: 'Rasa', serif; color: #225293;">
                        {{ $errors->first() }}
                    </span>
                </div>
            </div>
