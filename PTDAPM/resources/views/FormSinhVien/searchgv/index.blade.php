            ...
            <div class="modal-content"
                ...
                <div class="modal-body d-flex flex-column text-start">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="row g-0" style="color: #17488C;">
                                ...
                                <p class="col-md-9" style="color:17488C">{{ $gv->ten_gv }}</p>
                            </div>
                            <div class="row g-0" style="color: #17488C;">
                    ...
                    <div class="text-center-col">
                        <a type="button" data-bs-toggle="modal" data-bs-target="#inviteModal" style="color: #17488C;">
                            Gửi lời mời hướng dẫn
                        </a>
                    </div>
                </div>
    ...
    <div class="modal fade" id="inviteModal" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color: #E7F5FF; border-radius: 0; color: #225293;">
                ...
                <form action="{{ route('FormSinhVien.searchgv.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label fw-bold" style="text-decoration: none !important;">Tên
                                sinh viên:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control bg-primary-subtle" name="ten_sv"
                                    placeholder="Nhập tên sinh viên" style="text-decoration: none !important;"
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label fw-bold" style="text-decoration: none !important;">Mã
                                sinh viên:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control bg-primary-subtle" name="ma_sv"
                                    placeholder="Nhập mã sinh viên" style="text-decoration: none !important;"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="email" class="form-control bg-primary-subtle" name="email"
                                    placeholder="Nhập email" style="text-decoration: none !important;"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group">
                                <label for="ma_de_tai">Chọn Đề Tài (nếu có):</label>
                                <select name="ma_de_tai" id="ma_de_tai" class="form-control">
                                    <option value="">Không có</option>
                                    @foreach($deTais as $dt)
                                    <option value="{{ $dt->ma_de_tai }}">{{ $dt->ten_de_tai }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
