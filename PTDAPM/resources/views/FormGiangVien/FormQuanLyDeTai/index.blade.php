...
@section('content')
            ...
            <div class="modal-body">
                <form>
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tenDeTai" style="background-color: #799DCB; border: none; border-radius: 10px; color: #17488C;">
                        </div>
                    </div>
                    <div class="row mb-3 align-items-center">
                        <label for="moTa" class="col-sm-3 col-form-label fw-bold" style="color: #17488C;">Mô tả:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="moTa" style="background-color: #799DCB; border: none; border-radius: 10px; color: #17488C;">
                        </div>
                    </div>
                    <div class="row mb-3 align-items-center">
                        <label for="trangThai" class="col-sm-3 col-form-label fw-bold" style="color: #17488C;">Trạng thái:</label>
                        <div class="col-sm-9">
                            <select class="form-select" id="trangThai" style="background-color: #799DCB; border: none; border-radius: 10px; color: #17488C;width:30%">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="linhVuc" style="background-color: #799DCB; border: none; border-radius: 10px; color: #17488C;">
                        </div>
                    </div>
                    <div class="row mb-3 align-items-center">
                        <label for="soLuongSV" class="col-sm-3 col-form-label fw-bold" style="color: #17488C;">Số lượng sinh viên:</label>
                        <div class="col-sm-9">
                            <select class="form-select" id="soLuongSV" style="background-color: #799DCB; border: none; border-radius: 10px; color: #17488C;width:20%">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>MD01</td>
        <td><a type="button" data-bs-toggle="modal" data-bs-target="#xembaocao">Nghiên cứu về sự tiến hóa của Virus trong tương lai.</a></td>
        <td class="text-center">Đã xét duyệt</td>
        <td class="text-center">Đã nộp báo cáo</td>
      </tr>
      <tr>
        <td>MD02</td>
        <td><a type="button" data-bs-toggle="modal" data-bs-target="#xembaocao">Ứng dụng trí tuệ nhân tạo trong nhận diện khuôn mặt.</a></td>
        <td class="text-center">Chờ xét duyệt</td>
        <td class="text-center">Nộp báo cáo</td>
      </tr>
      <tr>
        <td>MD03</td>
        <td><a type="button" data-bs-toggle="modal" data-bs-target="#xembaocao">Phát triển thuật toán học máy để dự đoán giá cổ phiếu.</a></td>
        <td class="text-center">Chờ xét duyệt</td>
        <td class="text-center">Nộp báo cáo</td>
      </tr>
      <tr>
        <td>MD04</td>
        <td><a type="button" data-bs-toggle="modal" data-bs-target="#xembaocao">Tối ưu hóa hiệu suất mạng bằng thuật toán học sâu.</a></td>
        <td class="text-center">Đã xét duyệt</td>
        <td class="text-center">Đã nộp báo cáo</td>
      </tr>
      <tr class="empty-row">
...
<div class="modal fade" id="suadetai" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 700px;">
        <div class="modal-content" style="background-color: #e3f0ff; padding: 20px; border-radius: 10px; border: none;">
            ...
            <!-- Footer -->
            <div class="modal-footer d-flex justify-content-end">
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#dongyy"
                    style="background-color: #799DCB; color: #17488C; font-weight: bold;
                    border-radius: 15px; padding: 8px 25px; font-size: 16px;">
                    Đồng ý
                </button>
