...
@section('content')
  ...
  <div class="modal fade" id="xacnhanModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content" style="background-color: #d9eaff; padding: 30px; border-radius: 15px;">
      ...
      <button type="button" data-bs-toggle="modal" data-bs-target="#dongy" style="background-color: rgba(81, 131, 202, 0.6); color: #17488C;
      ...
      <button type="button" class="btn" style="background-color: rgba(81, 131, 202, 0.6); color: #17488C;
         border-radius: 22px; padding: 10px 30px; font-size: 18px; font-weight: bold;" data-bs-dismiss="modal">
        Từ chối
      </button>
      </div>
    </div>
