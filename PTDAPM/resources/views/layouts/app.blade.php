...
<body>
    <div class="page-wrapper">
        <!-- Header -->
        <div class="header">
            <img src="img/Logo-Thuy_Loi.png" alt="Logo Thủy Lợi" class="logo" />
            <h1 class="school-name">TRƯỜNG ĐẠI HỌC THỦY LỢI</h1>
            <div class="user-info">
                <img src="img/Test Account.png" alt="User Icon" class="user-icon" />
                <span class="user-name">Nguyễn văn A</span>
                <div class="dropdown">
                    <button class="dropdown-button">
                        <img src="img/Chevron Down.png" alt="Dropdown" class="dropdown-icon" />
                    </button>
                    <div class="dropdown-content">
                        <a href="#">
                            <img src="img/User Male.png" alt="Profile" class="menu-icon" />
                            Cập nhật thông tin cá nhân
                        </a>
                        <a href="#">
                            <img src="img/Security Shield.png" alt="Password" class="menu-icon" />
                            Đổi mật khẩu
                        </a>
                        <a href="#">
                            <img src="img/Move Up.png" alt="Logout" class="menu-icon" />
                            Đăng xuất
                        </a>
                    </div>
                </div>
