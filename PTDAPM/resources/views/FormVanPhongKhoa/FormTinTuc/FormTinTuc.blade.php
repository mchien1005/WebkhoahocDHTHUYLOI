...
.divider {
    background-color: #245292; /* Màu xanh theo yêu cầu */
    margin: 20px 0; /* Khoảng cách trên dưới */
    width: 100%; /* Độ dài 100% để kéo dài toàn bộ */
}
.news-meta {
    color: #255293;
font-family: Rasa;
        ...
        <div class="news-item">
            ...
            <div class="news-content">
                ...
                <div class="news-action">
                    <a href="{{ route('vanphongkhoa.chitiettintuc', ['ma_tin_tuc' => $item->ma_tin_tuc]) }}" class="news-link">
