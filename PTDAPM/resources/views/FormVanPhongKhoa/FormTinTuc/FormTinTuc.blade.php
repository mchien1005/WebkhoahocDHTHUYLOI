...
<div class="main-content">
    ...
    <div class="news-section">
        <div class="news-item">
            <img src="{{asset('images/3-02-4392jpg-9516-6273.jpg 1.png')}}" alt="Nghiên cứu khoa học" class="news-image" />
            <div class="news-content">
                ...
                <p class="news-excerpt">
                    ...
                    khoa học, công nghệ, đổi mới sáng tạo và <a href="#" class="text-link">chuyển đổi số quốc gia</a> vừa được ký ban hành...
                </p>
                <div class="news-link">
                    <img src="{{asset('images/Chevron Right.png')}}" alt="Arrow" />
                    <span>Xem chi tiết tin tức</span>
    ...
    <div class="divider"></div>
          ...
          <div class="news-section">
            <div class="news-item">
              ...
              <div class="news-content">
                <h3 class="news-title">17 công trình vào chung khảo Giải thưởng khoa <br/>học công nghệ dành cho giảng viên trẻ</h3>
