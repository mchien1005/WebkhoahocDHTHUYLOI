            ...
            <div class="flex space-x-4">
                ...
                <div class="bg-blue-300 p-4 rounded w-1/2">
                    <div class="flex justify-between items-center mb-4">
                        <select id="select1" class="bg-blue-300 text-white p-2 rounded" onchange="updateMembers(this, 'members1', 'select2', 'members2')">
                            <option value="">Chọn hội đồng</option>
                            <option value="Hội đồng 1">Hội đồng 1</option>
                            <option value="Hội đồng 2">Hội đồng 2</option>
                        </select>
                    </div>
                    <img src="{{asset('images/People.png')}}" class="mx-auto mb-4" height="100" src="images/People.png" width="100"/>
                    <div id="members1"></div>
                </div>
                <!-- Hội đồng 2 -->
                <div class="bg-blue-300 p-4 rounded w-1/2">
